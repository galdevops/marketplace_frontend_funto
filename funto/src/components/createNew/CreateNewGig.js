...
const CreateNewGig = () => {
    const [inputTitle, setInputTitle] = useState('Macaw Jap');
    const [inputPrice, setInputPrice] = useState('112.00 USD');
                        ...
                        <div className="create-new-form border shadow-sm p-4 p-sm-5">
                            ...
                            <Form>
                                <div className="row align-items-center">
                                    ...
                                    <div className="col-12">
                                        <Form.Group className="mb-4">
                                            <Form.Label className="mb-2 fz-16">Gig Title</Form.Label>
                                    ...
                                    <div className="col-12">
                                        <Form.Group className="mb-4">
                                            <Form.Label className="mb-2 fz-16">Gig Description</Form.Label>
                                    ...
                                    <div className="col-12 col-md-6">
                                        <Form.Group className="mb-4">
                                            <Form.Label className="mb-2 fz-16">Gig Price</Form.Label>
