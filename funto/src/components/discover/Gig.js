...
const GigDetails = props => {
    const discoverID = parseInt(useParams().DISCOVERID, 10) || parseInt(props.gig)
                ...
                <div className="card-body">
                    <div className="img-wrap">
                        ...
                        <Dropdown className={`section-${elem.dropdownVisibility}`} >
                            <Dropdown.Toggle className=" shadow-sm" id={`discoverID${elem.id}`}>
                    ...
                    <div className="row gx-2 align-items-center mt-3">
                        <div className="col-6">
                            <Link className={`btn btn-${elem.buttonGroup[0].leftButtonStyle}  btn-sm`} to={elem.buttonGroup[0].leftButtonURL} >
                        ...
                        <div className="col-12 col-md-9 col-lg-6">
                            <div className="item-details-content mt-5 mt-lg-0">
                                ...
                                <Dropdown className={`section-${discoverData.dropdownVisibility} item-details-dd`} >
                                    <Dropdown.Toggle className=" shadow-sm p-0" id={`discoverDetailsID${discoverData.id}`}>
                                        <i className="bi bi-three-dots-vertical" />
                                    </Dropdown.Toggle>
                                ...
                                <div className="d-flex flex-wrap align-items-center">
                                    {/* Wishlist */}
                                    <button className="btn btn-danger btn-sm  px-3 wishlist-btn" type="button">
                                        <i className="bi" />
                                        <span className="ms-1">
                                    ...
                                    {/* Badge */}
                                    <div className="badge border px-3 py-2  text-dark fz-14 d-inline-block ms-1 ms-sm-4">
                                ...
                                <div className="row align-items-end">
                                    ...
                                    <div className="col-6 col-sm-4 col-lg-5">
                                        <Link className={`btn btn-${discoverData.buttonGroup[0].leftButtonStyle}  w-100`} to={discoverData.buttonGroup[0].leftButtonURL} >
                                            <img 
                                                className="me-1" 
